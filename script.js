...
const LANG = {
  en: {
    title: 'Gmail Lab', subtitle: '📧 search · 📖 read · ✏️ draft',
    disconnected: 'Disconnected', connected: 'Connected',
    mainSection: 'Gmail Lab', mainDesc: 'Sign in with Google to explore your inbox',
    sectionA: 'Quick Commands — Tap to Run!', sectionB: 'How It Works',
    activityLog: 'Activity Log', eventsMsg: 'Events & messages',
    clear: 'Clear', copy: 'Copy', theme: 'Theme',
    settings: '⚙️ Settings', language: 'Language',
    helpSettings: '❓ Help & Settings', settingsTab: '⚙️',
    help: '❓ Help', faq: 'FAQ', howto: 'How-To', wiki: 'Wiki',
    faq_q1: 'What is Gmail Lab?', faq_a1: 'Gmail Lab lets you explore your Gmail inbox — search, read, and learn Gmail search syntax!',
    faq_q2: 'How do I connect?', faq_a2: 'Enter your Google OAuth Client ID, then click Sign in with Google.',
    faq_q3: 'Is it safe?', faq_a3: 'Yes! Read-only access — cannot modify, delete, or send emails.',
    faq_q4: 'Can anyone use it?', faq_a4: 'Yes! Each user signs in with their own Google account. No data is shared.',
    howto_1: 'Get a Google OAuth Client ID (see Setup section).',
    howto_2: 'Paste your Client ID and click Sign in with Google.',
    howto_3: 'Tap any Quick Command button to search your inbox.',
    howto_4: 'Click any email in the results to read the full message.',
  ...
  fr: {
    title: 'Labo Gmail', subtitle: '📧 chercher · 📖 lire · ✏️ rédiger',
    disconnected: 'Déconnecté', connected: 'Connecté',
    mainSection: 'Labo Gmail', mainDesc: 'Connecte-toi avec Google pour explorer ta boîte mail',
    sectionA: 'Quick Commands — Tap to Run!', sectionB: 'How It Works',
  ...
  ar: {
    title: 'مختبر Gmail', subtitle: '📧 بحث · 📖 قراءة · ✏️ كتابة',
    disconnected: 'غير متصل', connected: 'متصل',
    mainSection: 'مختبر Gmail', mainDesc: 'سجّل دخولك مع Google لاستكشاف بريدك',
    sectionA: 'أوامر سريعة — جرّب!', sectionB: 'كيف يعمل',
